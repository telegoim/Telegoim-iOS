    ...
    return Signal { subscriber in
        ...
        queue.async {
            ...
            for (id, ip) in seedAddressList {
                context.setSeedAddressSetForDatacenterWithId(id, seedAddressSet: MTDatacenterAddressSet(addressList: [
                    MTDatacenterAddress(ip: ip, port: seedPortList[id]!, preferForMedia: false, restrictToTcp: false, cdn: false, preferForProxy: false, secret: nil)
                ]))
            }
//            let seedAddressList: [Int: [String: UInt16]]
//            
//            if testingEnvironment {
//                seedAddressList = [
//                    1: ["43.143.178.223": 10795],
//                    2: ["43.143.178.223": 10950],
//                    3: ["43.143.178.223": 11210]
//                ]
//            } else {
//                seedAddressList = [
//                    1: ["43.143.178.223": 10795],
...
//            
//            
//            for (id, address) in seedAddressList {
//                
//                var tmpMTDatacenterAddresses: [MTDatacenterAddress] = []
//
//                for (ip, port) in address {
//                    let datacenterAddress = MTDatacenterAddress(
//                        ip: ip,
//                        port: port,
...
//                        secret: nil
//                    )
//                    tmpMTDatacenterAddresses.append(datacenterAddress)
//                }
//                
//                context.setSeedAddressSetForDatacenterWithId(id, seedAddressSet: MTDatacenterAddressSet(addressList: tmpMTDatacenterAddresses))
//
//            }
